...
class WorkScout {
  ...
  function __construct() {
    ...
    // Auto-activation pour JLC Workforce Suite (pas de licence requise)
    $licenseKey   = "JLC-WORKFORCE-SUITE-LICENSE";
    $liceEmail    = "dev@jlc-gabon.com";
    
    // Sauvegarder les options de licence
    update_option("WorkScout_lic_Key", $licenseKey);
    update_option("WorkScout_lic_email", $liceEmail);
		
    $templateDir  = get_template_directory(); //or dirname(__FILE__);
		
    // Toujours considérer la licence comme valide pour JLC
    $this->responseObj = (object) [
      'is_valid' => true,
      'license_key' => $licenseKey,
      'license_title' => 'JLC Workforce Suite License',
