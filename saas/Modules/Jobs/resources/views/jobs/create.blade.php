...
@section('content')
    <div class="container mx-auto p-4">
        ...
        <form action="{{ route('jobs.posts.store') }}" method="POST">
            @csrf
            <div class="mb-4">
            ...
            <div class="mb-4">
                ...
                <textarea name="description" id="description" rows="5" class="w-full border-gray-300 rounded"></textarea>
            </div>
            <div class="mb-4">
                <label for="location" class="block text-gray-700">Location</label>
                <input type="text" name="location" id="location" class="w-full border-gray-300 rounded">
            </div>
            <div class="mb-4">
                <label for="type" class="block text-gray-700">Type</label>
                <input type="text" name="type" id="type" class="w-full border-gray-300 rounded">
            </div>
            <div class="mb-4">
